...
class tree {
   ...
   public:
      ...
      /// Return iterator to the last node of the tree.
      inline pre_order_iterator   back() const;
...
template <class T, class tree_node_allocator>
typename tree<T, tree_node_allocator>::pre_order_iterator tree<T, tree_node_allocator>::back() const
   {
...
template <class T, class tree_node_allocator>
typename tree<T, tree_node_allocator>::sibling_iterator tree<T, tree_node_allocator>::iterator_base::back() const
   {
   if(node->first_child==0) 
      return end();
