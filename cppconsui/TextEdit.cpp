...
size_t TextEdit::MoveLogically(size_t start, int direction)
{
...
size_t TextEdit::MoveForwardWordFromCursor()
{
...
size_t TextEdit::MoveBackwardWordFromCursor()
{
  size_t new_pos = current_pos;
  const char *cur = point;
  bool nonwhite = false;
