...
public:
	...
	/**
	 * Inserts a widget before a specified position. TreeView takes ownership
	 * of the widget.
	 */
	NodeReference InsertNode(const NodeReference position,
			Widget& widget);
	/**
	 * Inserts a widget after a specified position. TreeView takes ownership
	 * of the widget.
	 */
	NodeReference InsertNodeAfter(const NodeReference position,
			Widget& widget);
	/**
	 * Prepends a widget to a specified parent. TreeView takes ownership of
	 * the widget.
	 */
...
protected:
	...
	private:
		...
		/**
		 * Widget to show. Not const because width is changed to fit. E.g.
		 * labels can show `...' when the text does not fit in the given
		 * space.
		 */
		Widget *widget;
