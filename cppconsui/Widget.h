...
public:
	 ...
	 * successful if the widget is visible and all predecessors are visible
	 * too.
	 */
	 ...
	 * that the widget has been updated and that it should be redrawn. Usually
	 * only the @ref Container of a widget is connected to this signal.
	 */
